...
/* =========================
   FILTER LABEL FIX (TEXT INVISIBLE FIX)
========================= */
...
/* FIX text slider label kalau ada */
[data-testid="stSlider"] label {
    color: #1e3a8a !important;
    font-weight: 700 !important;
}

/* FIX container title FILTER PANEL */
.filter-title {
    font-weight: 800;
    color: #1e3a8a;
    font-size: 15px;
...
/* Tab aktif langsung biru saat diklik */
...
© 2026 StrokeAI Analytics Dashboard
<br>
Facial Stroke Early Detection System
</div>
""", unsafe_allow_html=True)